...
public class Sculpture extends javax.swing.JFrame {

    /**
     * Creates new form Sculpture
     */
    public Sculpture() {
        initComponents();
        ...
        try {
            ...
            Statement st = con.createStatement();
                ...
                ResultSet rs = st.executeQuery("select * from tblartproducts where ArtType='Sculptures'");
    ...
    private void initComponents() {
        ...
        getContentPane().add(pnlArtTypeMenu, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 120, 170, 90));
    ...
    private void lblHomeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblHomeMousePressed
        ...
        //UserDashboardFrame.lblUser.setText(UserDashboardFrame.getUserName());
